...
public class PCTUTORSAPIPCTutorsAPIClient: AWSAPIGatewayClient {

	static let AWSInfoClientKey = "PCTUTORSAPIPCTutorsAPIClient"

	private static let _serviceClients = AWSSynchronizedMutableDictionary()
	private static let _defaultClient:PCTUTORSAPIPCTutorsAPIClient = {
        ...
        return PCTUTORSAPIPCTutorsAPIClient(configuration: serviceConfiguration!)
	}()
	...
	/**
	 ...
	 Then call the following to get the default service client:
	     ...
	     let serviceClient = PCTUTORSAPIPCTutorsAPIClient.default()

     Alternatively, this configuration could also be set in the `info.plist` file of your app under `AWS` dictionary with a configuration dictionary by name `PCTUTORSAPIPCTutorsAPIClient`.
	
	 @return The default service client.
	 */ 
	 
	public class func `default`() -> PCTUTORSAPIPCTutorsAPIClient{
	...
	/**
	 ...
	 If you want to enable AWS Signature, set the default service configuration in `func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?)`
	     ...
	     func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
	         ...
	         PCTUTORSAPIPCTutorsAPIClient.registerClient(withConfiguration: configuration, forKey: "USWest2PCTUTORSAPIPCTutorsAPIClient")
	 ...
	 Then call the following to get the service client:
	     ...
	     let serviceClient = PCTUTORSAPIPCTutorsAPIClient.client(forKey: "USWest2PCTUTORSAPIPCTutorsAPIClient")
	...
	public class func registerClient(withConfiguration configuration: AWSServiceConfiguration, forKey key: String){
		_serviceClients.setObject(PCTUTORSAPIPCTutorsAPIClient(configuration: configuration), forKey: key  as NSString);
	}
	 ...
	 */
	public class func client(forKey key: String) -> PCTUTORSAPIPCTutorsAPIClient {
		objc_sync_enter(self)
		if let client: PCTUTORSAPIPCTutorsAPIClient = _serviceClients.object(forKey: key) as? PCTUTORSAPIPCTutorsAPIClient {
			objc_sync_exit(self)
		    return client
		}
		...
		if let serviceInfo = serviceInfo {
			...
			PCTUTORSAPIPCTutorsAPIClient.registerClient(withConfiguration: serviceConfiguration!, forKey: key)
		}
		objc_sync_exit(self)
		return _serviceClients.object(forKey: key) as! PCTUTORSAPIPCTutorsAPIClient;
	}
	...
	init(configuration: AWSServiceConfiguration) {
	    ...
	    var URLString: String = "https://nhuyiydk6h.execute-api.us-east-1.amazonaws.com/dev"
    ...
    /*
     ...
     return type: 
     */
    public func matchOptions() -> AWSTask<AnyObject> {
	    ...
	    return self.invokeHTTPRequest("OPTIONS", urlString: "/match", pathParameters: pathParameters, queryParameters: queryParameters, headerParameters: headerParameters, body: nil, responseClass: nil)
	}
    ...
    /*
     ...
     return type: 
     */
    public func matchProxyOptions(proxy: String) -> AWSTask<AnyObject> {
	    let headerParameters = [
                   "Content-Type": "application/json",
                   "Accept": "application/json",
	    ...
	    return self.invokeHTTPRequest("OPTIONS", urlString: "/match/{proxy+}", pathParameters: pathParameters, queryParameters: queryParameters, headerParameters: headerParameters, body: nil, responseClass: nil)
	}
